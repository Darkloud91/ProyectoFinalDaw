...
if ((isset($_POST["Insertar_clase"])) && ($_POST["Insertar_clase"] == "si")) {
	if($_POST['tipo']==1){
		...
		$tamanioReal="Mazmorra";
		}
	$dir_destino_imagen = 'images/mapas/';
...
if(is_uploaded_file($_FILES['imagen']['tmp_name'])){
  ...
  $insertSQL = sprintf("INSERT INTO mapa (nombre, nombre_ingles, area, nivel, tipo, avatar, orbe_revivir) VALUES (%s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString($_POST['orbe_revivir'], "int"));
...
<title>Añadir Mapa - Tree of Savior Fan Base Hispana</title>
<!-- InstanceEndEditable -->
...
<div class="row">
  ...
  <div class="row">
    ...
    <script>
     ...
     <div class="titulo"><h1 style="margin-left:0; margin-right:0;">Añadir mapas</h1></div> 
     <div class="row">
         ...
         <table align="center">
           ...
           <tr valign="baseline">
		    ...
		    <tr valign="baseline">
             ...
             <td><input type="text" class="form-control" name="area" value="" size="32" required/></td>
           </tr>
           <tr valign="baseline">
            ...
            <tr valign="baseline">
             ...
             <td><select class="form-control" name="tipo" required>
               <option value="1" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>>Ciudad</option>
               <option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>>Región</option>
               <option value="3" <?php if (!(strcmp(3, ""))) {echo "SELECTED";} ?>>Mazmorra</option>
             </select></td>
            </tr>
            <tr valign="baseline">
             <td nowrap="nowrap" align="right">Orbe revivir:</td>
             <td><select class="form-control" name="orbe_revivir" required>
               <option value="1" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>>Si</option>
               <option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>>No</option>
             </select></td>
           </tr>
           <tr valign="baseline">
             <td nowrap="nowrap" align="right">Nivel:</td>
             <td><input type="number" class="form-control" name="nivel" min="1" required></td>
           </tr>
           <tr valign="baseline">
             <td nowrap="nowrap" align="right">&nbsp;</td>
             <td><input class="btn btn-default"  type="submit" value="Crear mapa" /></td>
           </tr>
         </table>
