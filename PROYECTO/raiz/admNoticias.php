...
if ((isset($_POST["Insertar_clase"])) && ($_POST["Insertar_clase"] == "si")) {
	$dir_destino_imagen = 'images/noticias/';
	$imagen_subida_noticia = $dir_destino_imagen . basename($_FILES['imagen']['name']);

if(is_uploaded_file($_FILES['imagen']['tmp_name'])){
				if (move_uploaded_file($_FILES['imagen']['tmp_name'], $imagen_subida_noticia)) {
  $insertSQL = sprintf("INSERT INTO noticia (id_usuario, titulo, descripcion, fecha, tipo, imagen, ref) VALUES (%s, %s, %s, NOW(), %s, %s, %s)",
                       GetSQLValueString($_POST['id_usuario'], "int"),
                       GetSQLValueString($_POST['titulo'], "text"),
                       GetSQLValueString($_POST['descripcion'], "text"),
                       GetSQLValueString($_POST['tipo'], "int"),
					   GetSQLValueString($imagen_subida_noticia, "text"),
...
<title>Añadir Noticia - Tree of Savior Fan Base Hispana</title>
<!-- InstanceEndEditable -->
...
<div class="row">
  ...
  <div class="row">
    <div class="col2 col-md-12 content"><!-- InstanceBeginEditable name="contenido" --> 
     ...
     <div class="titulo"><h1 style="margin-left:0; margin-right:0;">Añadir Noticia</h1></div> 
     <div class="row">
       <form role="form" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data" method="post" name="formNoticia" id="formNoticia">
         <table align="center">
           <tr valign="baseline">
             <td nowrap="nowrap" align="right">Titulo:</td>
             <td><input type="text" class="form-control" name="titulo" value="" size="32" required/></td>
           </tr>
           <tr valign="baseline">
           ...
           <tr valign="baseline">
             ...
             <td><select class="form-control" name="tipo">
               <option value="1" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>>Noticia</option>
               <option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>>Parche Español</option>
               <option value="3" <?php if (!(strcmp(3, ""))) {echo "SELECTED";} ?>>Notas de Parche</option>
             </select></td>
           </tr>
           <tr valign="baseline">
             <td nowrap="nowrap" align="right">Imagen:</td>
             <td><input type="file" name="imagen" onchange="readimgNoticia(this);" required/> <img id="noticiapreview" /></td>
           </tr>
           <tr valign="baseline">
             <td nowrap="nowrap" align="right">URl de Referencia:</td>
             <td><input type="text" class="form-control" name="ref" value="" size="32" required/></td>
           </tr>
           <tr valign="baseline">
             <td nowrap="nowrap" align="right">&nbsp;</td>
             <td><input class="btn btn-default"  type="submit" value="Crear Noticia" /></td>
           </tr>
         </table>
