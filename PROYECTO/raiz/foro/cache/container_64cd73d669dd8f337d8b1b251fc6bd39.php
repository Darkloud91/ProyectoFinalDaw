...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['alfredoramos.defaultavatar.defaultavatar'] = new \alfredoramos\defaultavatar\includes\defaultavatar($this->get('dbal.conn'), $this->get('dbal.tools'), $this->get('user'), $this->get('template'), $this->get('config'), './../', 'php');
    }
    ...
    {
        return $this->services['rmcgirr83.genders.listener'] = new \rmcgirr83\genders\event\listener($this->get('request'), $this->get('template'), $this->get('user'), './../', 'php', 'ext/rmcgirr83/genders/images/');
    }
    ...
    {
        return $this->services['vse.abbc3.acp_manager'] = new \vse\abbc3\core\acp_manager($this->get('dbal.conn'), $this->get('request'), $this->get('user'), './../', 'php');
    }
    ...
    {
        return $this->services['vse.abbc3.bbcodes_display'] = new \vse\abbc3\core\bbcodes_display($this->get('dbal.conn'), $this->get('ext.manager'), $this->get('user'), './../');
    }
    ...
    {
        return $this->services['vse.abbc3.listener'] = new \vse\abbc3\event\listener($this->get('vse.abbc3.bbcodes_parser'), $this->get('vse.abbc3.bbcodes_display'), $this->get('controller.helper'), $this->get('template'), $this->get('user'), './../');
    }
    ...
    {
        return $this->services['vse.abbc3.wizard'] = new \vse\abbc3\controller\wizard($this->get('controller.helper'), $this->get('request'), $this->get('template'), $this->get('user'), './../');
    }
