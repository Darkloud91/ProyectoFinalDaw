...
class __TwigTemplate_68cfbee752733e976129d52212bc45d2bcd491cdbf73c6f03f64b5a0d0513fcd extends Twig_Template
{
...
\t\t\t";
        ...
        $this->env->loadTemplate('@rmcgirr83_genders/event/memberlist_view_user_statistics_before.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        // line 101
        echo "\t\t\t<dt>";
