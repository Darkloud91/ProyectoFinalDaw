...
//old ones            
    ...
    */
    ...
    public function tapa_header($event)
    {
        ...
        if($TT_connection->checkBannerControl($TT_bannerControlData, $TT_expireTime, $board_url, $api_key))
        {
            $cache->put('_tapatalk_banner_control', serialize($TT_bannerControlData));
            $cache->put('_tapatalk_banner_expire', $TT_expireTime);
        }
