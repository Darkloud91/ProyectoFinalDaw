...
Class MbqWrEtAtt extends MbqBaseWrEtAtt {
    ...
    public function uploadAttachment($oMbqEtForumOrConvPm, $groupId, $type) {
        ...
        $filesize = isset($message_parser->attachment_data[$new_attach_position]) ? $message_parser->attachment_data[$new_attach_position]['filesize'] : '';
        $filename = isset($message_parser->attachment_data[$new_attach_position]) ? $message_parser->attachment_data[$new_attach_position]['real_filename'] : '';
        if($attachment_id != '')
        {
