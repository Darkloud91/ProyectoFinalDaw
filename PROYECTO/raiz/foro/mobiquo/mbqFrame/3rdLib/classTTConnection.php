...
if(!class_exists('classTTConnection'))
{
	class classTTConnection
	{
         ...
         * Summary of bannerControlAllowedByPlugin
         * This function check for the ability of forum to do is how control of the smartbanner
         * @param mixed $bannerControlData this is the current value of bannercontrol, also outputs the new value. if true, forum can control if smartbanner will be shown or not. if false, plugin should force the smartbanner to be showed
         * @param mixed $expireTime this is the expire time of last check, also outputs the new value.
         * @param mixed $boardUrl the board url
         * @param mixed $apiKey the api key
         * @return bool returns true if $bannerControl and $bannerLastCheck values changed so we will need to store these on forum system for following calls.
         */
        public function checkBannerControl(&$bannerControlData, &$expireTime, $boardUrl, $apiKey)
        {
            try
            {
