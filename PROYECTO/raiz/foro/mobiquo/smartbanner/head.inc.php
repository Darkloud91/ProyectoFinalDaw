...
if ($app_rebranding_id)
{
    ...
    $app_icon_url = isset($app_icon_url) && $app_icon_url ? $app_icon_url : '';
    ...
    else
    {
        ...
        $app_ios_icon_url = "./$tapatalk_dir_name/smartbanner/images/tapatalk-banner-logo.png";
    ...
    else
    {
        ...
        $app_android_icon_url = "./$tapatalk_dir_name/smartbanner/images/tapatalk-banner-logo.png";
...
if (in_array($page_type, array('topic', 'post', 'home')) && $app_location)
{
    ...
    if ($twitter_indexing_enabled)
    {
        ...
        $twc_image = isset($twc_image) && $twc_image ? $twc_image : $app_icon_url;
...
{
    $app_banner_js_link = './' . tt_html_escape($tapatalk_dir_name) .'/smartbanner/appbanner.js?v=5.0';
