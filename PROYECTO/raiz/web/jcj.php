...
<title>JcJ - Tree of Savior Fan Base Hispana</title>
<!-- InstanceEndEditable -->
...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="titulo">
  	  <h1 style="margin-left:0; margin-right:0;">Liga de Batallas por Equipos(JcJ)</h1>
      </div>      
<div style="padding: 10px; padding-top: 5px;">
    Tree of Savior un modo de JcJ llamado <b>Liga de Batallas por Equipos</b>. Grupos de 5 miembros pueden solicitar entrar en determinados momentos.
    Entran a una arena cuando encuentran opente. El primer grupo que gane 3 rondas, gana la partida.
    
    <div style="width: 640px; margin: 0px auto; margin-top: 20px;">
        <video width="640" height="360" controls>
            <source src="videos/arena/arenapreview.mp4" type="video/mp4">
