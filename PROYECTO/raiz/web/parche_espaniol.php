...
<title>IPF Suite - Tree of Savior Fan Base Hispana</title>
<!-- InstanceEndEditable -->
...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="titulo">
  	  <h1 style="margin-left:0; margin-right:0;">Parche Español</h1>
      </div>      
<div style="padding-left: 10px;"><a href="descargas">Descargas</a> &bull; Parche Español</div><div style="padding: 10px;">Un parche que traduce Tree of Savior al Español.<br />
<br />
<b>Caracteristicas:</b><br />
- Nombres de objetos<br />
- Textos<br />
- Habilidades<br />
- mapas y mas...<br />
<br />
...
<br />
<b>Versión:</b><br />
1.3</div><div style="padding: 10px;">Tamaño: 25.7MB<br/><br/><a class="btn btn-default" href="https://github.com/TreeOfSavior-Spanish/Spanish-Patch/releases/download/V1.3/tos-SpanishPatch-20160601-13.zip">Descargar</a></div>          
