...
<title>Tablas de EXP - Tree of Savior Fan Base Hispana</title>
<!-- InstanceEndEditable -->
...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="titulo">
  	  <h1 style="margin-left:0; margin-right:0;">Tablas de EXP</h1>
      </div>      
<div style="padding: 10px; padding-bottom: 200px; text-align: center;">
    <a href="personajeEXP.php" class="btn btn-info">Tabla de EXP de personaje</a>
    <a href="claseEXP.php" class="btn btn-info">Tabla de EXP de clase</a>
    <a href="companieroEXP.php" class="btn btn-info">Tabla de EXP de compañero</a>
</div>   
